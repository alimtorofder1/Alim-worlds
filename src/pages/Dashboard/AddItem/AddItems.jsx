...
const AddItems = () => {
    ...
    const onSubmit = async(data) => {
      ...
      if(res.data.success){
        ...
        const productRes = await axiosSecore.post('/product',productItem)
    ...
    return (
        <div>
            <div>
                <h1 className="text-3xl text-center mt-11 mb-5">ADD AN ITEM</h1>
  ...
  <input type="text" placeholder="Product Name" {...register("name")} className="input input-bordered w-full" />
        </label>
        <div>
        <label  className="form-control w-full my-6 pl-7">
  <div className="label">
  ...
  <input type="text" placeholder="Product Name" {...register("oldprice")} className="input input-bordered w-full" />
        </label>
        </div>
        <div>
        <label  className="form-control w-full pl-7">
  ...
  <input type="text" placeholder="Product Name" {...register("price")} className="input input-bordered w-full" />
        </label>
        </div>
        </div>
        <div>
